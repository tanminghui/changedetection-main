...
def load_dataset(img_nums, n_augmentation_per_image, batch_size=1):
    ...
    for i, img_num in enumerate(img_nums):
        # Opening
        img_b = open_image("/content/drive/MyDrive/capstone/Lamboise-Master/DATA/Earth_" + str(img_num) + "/before.png")
        img_a = open_image("/content/drive/MyDrive/capstone/Lamboise-Master/DATA/Earth_" + str(img_num) + "/after.png")
        img_m = open_image("/content/drive/MyDrive/capstone/Lamboise-Master/DATA/Earth_" + str(img_num) + "/mask.png")
