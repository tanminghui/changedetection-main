...
[Miniconda](https://docs.conda.io/en/latest/miniconda.html). Once installed, create the environment:

```sh
conda create -y --name=changedetection python=3.8
```

activate it:

```sh
conda activate changedetection
```

and install the project in "development mode" (note, you must be in the project's toplevel directory
...
To launch the test suite, change to the project root directory and run:
```sh
pytest src/test/
```
